...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    self.root = root
    # Title of the window
    self.root.title("MUKTONE LITE - TEXTRO")
    # Window Geometry
    ...
    # Initializing Status
    self.status.set("&copy; MUKTONE ENGINE LITE - TEXTRO")
  ...
  def exit(self,*args):
    op = messagebox.askyesno("WARNING","Your Unsaved Data May be Lost!\nMuktone Textro holds no insurance towards such damages. :)")
    if op>0:
      self.root.destroy()
    else:
      return
  ...
  def infoabout(self):
    messagebox.showinfo("About Textro","MUKTONE ENGINE LITE \nTEXTRO v0.8.1 \n \n \nA minimalist, but creative, text editor by Muktone Engine's Lite Division. \nThis software is provided free of charge and is currently in its prototypical stage. \n \n \nVisit http://muktone.github.io for more content and free stuff!")
